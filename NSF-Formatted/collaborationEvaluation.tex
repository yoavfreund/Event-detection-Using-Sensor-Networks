...
%\rayan{Yoav, I edited quite a bit, hope this is OK} Yes, thank you!
...
\rayan{I put this in, but is this true?}
\yoav{It is true for me}
...
result from our work.  \rayan{Peter, please edit!} \yoav{Peter, it
  would be great if you could describe here how your work here will
  benefit your work in Scripps.}
...
%\rayan{Yoav, do you want to throw in that you have published in stats journals, as a nod to the missing discipline on our team?}
\item {\bf Co-PI Cloninger's} expertise... \yoav{please add yourself}
\item {\bf Co-PI Gerstoft's} expertise... \yoav{please add yourself}
...
{\bf Joint Students}\\
\rayan{Shouldn't we mention the postdoc here or elsewhere?}  In
...
{\bf Collaboration}\\ \rayan{see if you like these edits.}  Each
...
quarter and evaluate out algorithms on the collected data.\rayan{do we need a collaboaration letter from Prof. Christiansen?}
