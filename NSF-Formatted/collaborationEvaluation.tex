...
\begin{document}
\section*{\center{Collaboration and Evaluation Plan}}
\vspace{1cm}
...
\item {\bf Co-PI Cloninger's} expertise is in applied harmonic
  ...
  including data concentrated near manifolds or subspaces \cite{cloninger2018bigeometric,cloninger2017spectral,cloninger2018dual,cloninger2017pre}.  These
  types of problems arise in a number of scientific disciplines,
  including imaging \cite{cloninger2014lidar,cloninger2013case,cloninger2014solving,bai2015efficient} and medicine \cite{cloninger2016function,downing2017describing,bates2017outcome}, and the
  techniques developed relate to a number of machine learning and
  statistical algorithms , including deep learning \cite{shaham2018provable,mishne2017diffusion,katzman2018deepsurv}, network analysis \cite{cloninger2017note,cloninger2017prediction,cloninger2015eigenvector},
  and measuring distances between probability distributions \cite{cloninger2018people,cheng2017two,cloninger2018bounding}.
