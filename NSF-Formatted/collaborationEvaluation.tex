...
(1) We intend to compare our performance on the DCASE challenge dataset: Two tasks in acoustics and audio signal processing in the 2017 Detection and Classification of Acoustic Scenes and Events (DCASE) challenge.\cite{mesaros2017dcase}
