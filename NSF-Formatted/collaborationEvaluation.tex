...
\rayan{Yoav, I edited quite a bit, hope this is OK}
...
\rayan{not sure about this one, get rid of it if you don't like it. }\peter{\bf OK. Because it is written here does not mean we do it.}
...
quarter and evaluate out algorithms on the collected data.\rayan{do we need a collaboration letter from Prof. Christiansen?}
...
\peter{\bf Institute for  Sensor Network Data Science}
