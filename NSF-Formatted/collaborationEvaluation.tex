...
\\
(4) For electromagnetic data we have access to MIMO array data  capable of taking phase coherent measurements for the determination and characterization of electromagnetic (EM) channels. The array aperture is intended to be flexible, with a maximum inter element spacing around 5 wavelengths. 
\\
\\
{\bf Evaluation}\\
